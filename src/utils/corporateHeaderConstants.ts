/** Kurumsal başlık sabitleri — döngüsel import olmadan paylaşılır */

/** Başlık / banner metinleri — HTML ve canvas önizleme */
export const HEADER_FONT_FAMILY_CSS = '"Poppins", Inter, Helvetica, Arial, sans-serif'
export const HEADER_FONT_FAMILY_CANVAS = 'Poppins, Inter, Helvetica, Arial'
