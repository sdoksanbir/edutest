 ...
 * (src/utils/classicBannerTopRow.ts ile eşleşmeli)
 */
...
/** Klavyedeki Enter oku — sağa bakış (kalın ┌─▶). Path: y=0 üst. */
...
/** Shift+Enter satır kırımlarını korur; uzun satırları genişliğe göre böler. */
