...
export function resolveExamTypeOffsetXPt(config: HeaderConfig): number {
  return clampExamTypeOffsetXPt(
    (config as HeaderConfig & { examTypeOffsetXPt?: number }).examTypeOffsetXPt ??
      EXAM_TYPE_OFFSET_X_DEFAULT_PT,
  )
}

export function resolveExamTypeOffsetYPt(config: HeaderConfig): number {
  return clampExamTypeOffsetYPt(
    (config as HeaderConfig & { examTypeOffsetYPt?: number }).examTypeOffsetYPt ??
      EXAM_TYPE_OFFSET_Y_DEFAULT_PT,
  )
}
